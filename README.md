[![Build Status](https://dev.azure.com/michej/ContosoAir/_apis/build/status/michej.ContosoAir?branchName=master)](https://dev.azure.com/michej/ContosoAir/_build/latest?definitionId=2&branchName=master)
